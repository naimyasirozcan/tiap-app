    ...
    <div className="min-h-screen w-full flex items-center justify-center">
      <div className="w-full lg:px-[400px]">
        ...
        <div className="flex gap-4 items-center">
          <button id="sign-up-btn" className="rounded-lg h-9 w-[120px]" ><Link to={"/signup"} className="underline">Sign Up</Link></button>
          <button id="sign-up-btn" className="rounded-lg h-9 w-[120px]" ><Link to={"/login"} className="underline">Login</Link></button>
